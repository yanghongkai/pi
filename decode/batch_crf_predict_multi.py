...
def main(sess_buckets,filename,limit,w2v_path,model_out_path,correct_out_path):
...
if __name__=='__main__':
    ...
    main(sess_buckets,filename,limit,w2v_path,model_out_path,correct_out_path)
